# [full stack proxy nginx PrestaShop for everyone with docker compose](https://github.com/damalis/full-stack-proxy-nginx-prestashop-for-everyone-with-docker-compose)

If You want to build a reverse proxy website with PrestaShop at short time;

#### Full stack Proxy Nginx PrestaShop:
...
```
git clone https://github.com/damalis/full-stack-proxy-nginx-prestashop-for-everyone-with-docker-compose.git
```

Open a terminal and `cd` to the folder in which `docker-compose.yml` is saved and run:

```
cd full-stack-proxy-nginx-prestashop-for-everyone-with-docker-compose
chmod +x install.sh
./install.sh
```
...
Replace 'admin-dev' in this block with the name of your admin directory in the ```./proxy/templates/proxy.conf.template```.
